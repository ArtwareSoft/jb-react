...
function runSelectedScript(context) {
    ...
    let script = (0, tasks_1.findScriptAtPosition)(editor.document, contents, editor.selection.anchor);
    if (script) {
...
async function selectAndRunScriptFromFolder(context, selectedFolders) {
    ...
    let taskList = await (0, tasks_1.detectNpmScriptsForFolder)(context, selectedFolder);
