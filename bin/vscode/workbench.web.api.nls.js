...
define("vs/workbench/workbench.web.api.nls", {
	...
	"vs/platform/extensionManagement/common/abstractExtensionManagementService": [
		...
		"Can't install '{0}' extension because it is no longer supported. It is now part of the '{1}' extension as a pre-release version.",
	...
	"vs/platform/telemetry/common/telemetryService": [
		"Controls all core and first party extension telemetry. This helps us to better understand how {0} is performing, where improvements need to be made, and how features are being used.",
	...
	"vs/workbench/browser/parts/titlebar/titlebarPart": [
		"Icon for the layout control menu found in the title bar.",
		"[Unsupported]",
		"[Administrator]",
		"[Superuser]",
	...
	"vs/workbench/browser/workbench.contribution": [
		...
		"The panel spans from the far left of the window to the right side of the editor area.",
		"The panel spans beneath the editor area.",
		"The panel spans from the left side of the editor area to the far right of the window.",
		"The panel spans the full width of the window.",
		"Controls the alignment of the panel (terminal, debug console, output, problems) and whether or not it spans beneath the side bar and side panel. Note that this setting only takes effect when the panel is positioned at the bottom of the screen.",
	...
	"vs/workbench/common/auxiliarybar": [
	...
	"vs/workbench/contrib/extensions/browser/extensionsActions": [
		...
		"This extension no longer supported.",
		"This extension is now part of the {0} extension as a pre-release version.",
		"The '{0}' extension is not available in {1} for {2}.",
		"Learn More",
		"{0} for the Web",
	...
	"vs/workbench/contrib/files/browser/explorerViewlet": [
		...
		"Connected to remote.\n[Open Folder](command:{0})",
		"You have not yet opened a folder.\n[Open Folder](command:{0})\nOpening a folder will close all currently open editors. To keep them open, [add a folder](command:{1}) instead.",
		"You have not yet opened a folder.\n[Open Folder](command:{0})"
	],
	...
	"vs/workbench/contrib/interactive/browser/interactiveEditor": [
		"Type code here and press {0} to run"
	],
	...
	"vs/workbench/contrib/notebook/browser/view/output/outputRenderer": [
		"No renderer could be found for mimetype \"{0}\", but one might be available on the Marketplace.",
		"Search Marketplace",
		"Cell has no output",
	...
	"vs/workbench/contrib/preferences/browser/settingsTree": [
		"Extensions",
		"Sync: Ignored",
		"Settings sync does not sync this setting",
		"Modified",
		"More Actions... ",
		"Also modified in",
		"Modified in",
	...
	"vs/workbench/contrib/remote/common/tunnelFactory": [
		"Private",
		"Public"
	],
	...
	"vs/workbench/contrib/terminal/browser/terminalActions": [
		...
		"Clear",
		"Show Word Link Quick Pick",
		"Show Protocol Link Quick Pick",
		"Show Validated Link Quick Pick",
	...
	"vs/workbench/contrib/terminal/browser/terminalLinkQuickpick": [
	...
	"vs/workbench/contrib/terminal/common/terminalConfiguration": [
		...
		"the terminal's current working directory, displayed for multi-root workspaces or in a single root workspace when the value differs from the initial working directory. This will not be displayed for Windows.",
	...
	"vs/workbench/services/extensions/common/extensionsRegistry": [
		...
		"Use `extensionEnabledApiProposals` instead.",
	...
	"vs/workbench/services/themes/common/iconExtensionPoint": [
		...
		"The format of the font.",
		"'configuration.icons is a proposed contribution point. It requires 'package.json#enabledApiProposals: [\"contribIcons\"]' and is only available when running out of dev or with the following command line switch: --enable-proposed-api {0}",
		...
		"'configuration.iconFonts is a proposed contribution point. It requires 'package.json#enabledApiProposals: [\"contribIconFonts\"]' and is and only available when running out of dev or with the following command line switch: --enable-proposed-api {0}",
