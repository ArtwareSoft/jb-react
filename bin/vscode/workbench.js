 ...
 *--------------------------------------------------------*/
(function() {
var __m = ["vs/code/browser/workbench/workbench","require","exports","vs/base/browser/browser","vs/base/common/buffer","vs/base/common/cancellation","vs/base/common/event","vs/base/common/lifecycle","vs/base/common/network","vs/base/common/resources","vs/base/common/uri","vs/base/common/uuid","vs/base/parts/request/browser/request","vs/platform/product/common/product","vs/platform/windows/common/windows","vs/workbench/workbench.web.api"];
 ...
 *--------------------------------------------------------------------------------------------*/
define(__m[0/*vs/code/browser/workbench/workbench*/], __M([1/*require*/,2/*exports*/,3/*vs/base/browser/browser*/,4/*vs/base/common/buffer*/,5/*vs/base/common/cancellation*/,6/*vs/base/common/event*/,7/*vs/base/common/lifecycle*/,8/*vs/base/common/network*/,9/*vs/base/common/resources*/,10/*vs/base/common/uri*/,11/*vs/base/common/uuid*/,12/*vs/base/parts/request/browser/request*/,13/*vs/platform/product/common/product*/,14/*vs/platform/windows/common/windows*/,15/*vs/workbench/workbench.web.api*/]), function (require, exports, browser_1, buffer_1, cancellation_1, event_1, lifecycle_1, network_1, resources_1, uri_1, uuid_1, request_1, product_1, windows_1, workbench_web_api_1) {
    "use strict";
    ...
    (function () {
        ...
        // Create workbench
        (0, workbench_web_api_1.create)(document.body, {
            ...config,
