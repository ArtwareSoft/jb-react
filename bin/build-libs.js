...
const studioFiles = filesOfModules('common,ui-common,rx,ui-tree,dragula,codemirror,pretty-print,history,animate,fuse,md-icons').filter(x=>!x.match(/.css$/))
...
'core,common,ui-common,animate,d3,cards,cards-sample-data,pretty-print,parsing,xml,puppeteer,rx,md-icons,remote'
