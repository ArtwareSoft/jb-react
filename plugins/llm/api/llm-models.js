...
component('model', {
  ...
  params: [
    ...
    {id: 'speed', as: 'number', description: 'item/sec'},
...
component('o1_preview', {
  type: 'model',
  impl: model('o1-preview', 60, { quality: 12, speed: 0.1, reasoning: true  })
})
...
component('gpt_35_turbo_0125', {
  type: 'model',
  impl: model('gpt-3.5-turbo-0125', 1.5, { quality: 3, speed: 50 })
})
