component('text.htmlTag', {
  ...
  impl: customStyle((cmp,{text,htmlTag,cssClass},h) => h(`${htmlTag}.${cssClass}`,{},text), {
...
component('text.noWrappingTag', {
  type: 'text.style',
  category: 'text:0',
  impl: customStyle((cmp,{text},h) => text, { features: text.bindText() })
})
  
component('text.span', {
  type: 'text.style',
  impl: customStyle((cmp,{text},h) => h('span',{},text), { features: text.bindText() })
})

component('text.chip', {
  type: 'text.style',
  impl: customStyle((cmp,{text},h) => h('div.jb-chip',{},h('span',{},text)), { features: text.bindText() })
})
...
component('text.h2WithClass', {
  ...
  impl: customStyle((cmp,{text,clz},h) => h('h2',{class: clz},text), { features: text.bindText() })
})
...
component('text.textarea', {
  ...
  impl: customStyle((cmp,{text,rows,cols},h) => h('textarea', { rows: rows, cols: cols, value: text}), {
    features: text.bindText()
  })
})