  ...
  impl :{$: 'group', 
    ...
    controls: [
      ...
      {$: 'd3g.histogram', 
        ...
        items: '%$global.phones%', 
        pivot :{$: 'd3g.axis', title: 'hits', value: '%size%' }, 
        $disabled: true
      }, 
      {$: 'group', 
        title: 'chart-props', 
      ...
      >.property>div>label {
        ...
        controls: [
          {$: 'd3g.histogram', 
            frame :{$: 'd3g.frame', width: '300', height: '100', top: 30, right: 50, bottom: 40, left: 60 }, 
            items: '%$global.phones%', 
            pivot :{$: 'd3g.axis', title: 'perf', value: '%performance%' }, 
          ...
          {$: 'd3g.histogram', 
            frame :{$: 'd3g.frame', width: '300', height: '100', top: 30, right: 50, bottom: 40, left: 60 }, 
            items: '%$global.phones%', 
            pivot :{$: 'd3g.axis', title: 'hits', value: '%hits%' }, 
            features :{$: 'd3g.item-indicator', item: '%$item%' }, 
          ...
          {$: 'd3g.histogram', 
            frame :{$: 'd3g.frame', width: '300', height: '100', top: 30, right: 50, bottom: 40, left: 60 }, 
            items: '%$global.phones%', 
            pivot :{$: 'd3g.axis', title: 'size', value: '%size%' }, 
            features :{$: 'd3g.item-indicator', item: '%$item%' }, 
