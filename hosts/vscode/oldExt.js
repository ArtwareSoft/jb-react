...
class jBartStudio {
    ...
    studioHtml(jbModuleUrl, jbBaseProjUrl, jbProjectSettings, jbDocsDiffFromFiles) {
        ...
        const studioDev = `<script type="text/javascript" src="${jbBaseProjUrl}/plugins/loader/jb-loader.js"
...
<html>
	...
	<body class="vscode-studio">
		...
		<script>
          self.spy = jb.spy.initSpy({spyParam: 'all'})
          jb.studio.vsCodeApi = acquireVsCodeApi()
          jb.exec({$: 'data<>defaultTheme'})
          jb.ui.renderWidget({$:'control<>studio.main'},document.getElementById('studio'))
		</script>
	</body>
</html>`;
    }
